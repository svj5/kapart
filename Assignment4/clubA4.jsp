<%@ page import="java.sql.*"%>
   ...
   <%
         ...
         if ((request.getParameter("update")).equals("insert")) {
           try {
               result = statement.executeUpdate("INSERT INTO Members (clubMembers, MemberAddress, MemberTelephonenumber, 		MemberNumber, MemberAge, MemberStartdate) VALUE ('" + request.getParameter("newMemberName", "newMemberAddress", 		"newMemberTelephoneNumber", "newMemberNumber", "newMemberAge", "newmemberStartdate") + "')");
               if (result == 1)
                 out.println("User '" + request.getParameter("newMemberName") + "' and their member information was successfully added 		to members list");
               }catch (Exception ex) {
